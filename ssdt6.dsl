 ...
 *
 * Disassembly of ssdt6.dat, Tue Jun 26 22:21:27 2018
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00003111 (12561)
 *     Revision         0x02
 *     Checksum         0xA6
 *     OEM ID           "SaSsdt"
 *     OEM Table ID     "SaSsdt "
...
DefinitionBlock ("", "SSDT", 2, "SaSsdt", "SaSsdt ", 0x00003000)
{
    ...
    External (_SB_.PCI0.GFX0.HDOS, MethodObj)    // 0 Arguments         // DISABLE OUTPUT SWITCHING [(call external) HANDLER??] 
    External (_SB_.PCI0.GFX0.HNOT, MethodObj)    // 1 Arguments         // NOTIFY (external) HANDLER ???
    ...
    OperationRegion (SANV, SystemMemory, 0x8BE94418, 0x01F7)
    ...
    Scope (\_SB.PCI0.GFX0)
    {
        ...
        Method (GNOT, 2, NotSerialized)     // NOTIFY GFX0 ???
        {
            If (PDRD ())
            {
                Return (One)
