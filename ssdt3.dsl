 ...
 *
 * Disassembly of ssdt3.dat, Tue Jun 26 22:21:27 2018
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00000542 (1346)
 *     Revision         0x02
 *     Checksum         0xB3
 *     OEM ID           "MSFT  "
...
DefinitionBlock ("", "SSDT", 2, "MSFT  ", "Tpm2Tabl", 0x00001000)
{
    Scope (\_SB)
    {
        Device (TPM)
        {
            ...
            {
                Return (RESO) /* \_SB_.TPM_.RESO */
            }

            Method (_SRS, 1, Serialized)  // _SRS: Set Resource Settings
            {
                CreateDWordField (Arg0, 0x11, IRQ0)
                CreateDWordField (RESO, \_SB.TPM._Y27._INT, LIRQ)  // _INT: Interrupts
                LIRQ = IRQ0 /* \_SB_.TPM_._SRS.IRQ0 */
                CreateBitField (Arg0, 0x79, ITRG)
                CreateBitField (RESO, \_SB.TPM._Y27._HE, LTRG)  // _HE_: High-Edge
                LTRG = ITRG /* \_SB_.TPM_._SRS.ITRG */
                CreateBitField (Arg0, 0x7A, ILVL)
                CreateBitField (RESO, \_SB.TPM._Y27._LL, LLVL)  // _LL_: Low Level
            ...
            OperationRegion (TNVS, SystemMemory, 0x8BE91000, 0x2A)
